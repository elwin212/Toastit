  ...
  return (
    ...
    <div className="grid grid-cols-1 md:grid-col-3 gap-y-4 md:gap-x-4 py-6">
      ...
      <div className="overflow-hidden h-fit rounded-lg border border-gray-200 order-first md_order-last">
        <div className="bg-yellow-200 px-6 py-4 flex justify-between items-center">
          <p className="font-semibold py-3 flex items-center gap-1.5">
            <HomeIcon className="w-4 h-4"/>
            Home
          </p>
          <p className="font-semibold text-sm text-zinc-500">This website is still in progress, stay tuned!</p>
        </div>
