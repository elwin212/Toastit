    ...
    return <div className="container flex items-center h-full max-w-3xl mx-auto">
            <div className="relative bg-white w-full h-fit p-4 rounded-lg space-y-6">
                ...
                <div>
                    ...
                    <p className="text-xs pb-2">Group name including capitalization can not be changed.</p>
                ...
                <div className="flex justify-end gap-4">
                    ...
                    <Button isLoading={isLoading} disabled={input.length === 0} onClick={() => createGroup()}>Create Group</Button>
                </div>
            </div>     
        </div>
}
